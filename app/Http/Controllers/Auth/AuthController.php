...
class AuthController extends Controller
{
    ...
    public function postLogin(Request $request): RedirectResponse
    {
        ...
        if (Auth::attempt($credentials)) {
            ...
            return redirect()->intended('dashboard')
                        ->withSuccess('Anda berhasil masuk menggunakan Token');
        }
  
        return redirect("login")->withSuccess('Ups! Ada yang salah nih, ayo coba lagi!');
    }
    ...
    {  
        ...
        return redirect("dashboard")->withSuccess('Bagus! Anda berhasil menambahkan akun');
    }
